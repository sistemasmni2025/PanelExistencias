  ...
  return (
    <>
      ...
      <aside className={`
        ...
        w-64 bg-slate-800 text-slate-300 flex flex-col shadow-2xl transition-transform duration-300 ease-in-out shrink-0
      ...
      `}>
        ...
        <div className="p-4 bg-slate-800/50 border-b border-slate-700">
          <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4 flex items-center gap-2">
            <Settings className="w-3 h-3" /> Filtros Técnicos
          </h3>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <label className="text-[9px] font-bold text-slate-400 uppercase ml-1">Ancho</label>
              <input type="text" placeholder="0.00" className="w-full bg-slate-900/50 border border-slate-700 rounded-lg py-1.5 px-3 text-xs text-white focus:border-brand-blue outline-none transition-all placeholder:text-slate-600" />
            </div>
            <div className="space-y-1.5">
              <label className="text-[9px] font-bold text-slate-400 uppercase ml-1">Serie</label>
              <input type="text" placeholder="0" className="w-full bg-slate-900/50 border border-slate-700 rounded-lg py-1.5 px-3 text-xs text-white focus:border-brand-blue outline-none transition-all placeholder:text-slate-600" />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <input type="text" placeholder="..." className="w-full bg-slate-900/50 border border-slate-700 rounded-lg py-1.5 px-3 text-xs text-white focus:border-brand-blue outline-none transition-all placeholder:text-slate-600" />
            </div>
          </div>
          
          <div className="mt-4 flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input type="checkbox" className="w-3.5 h-3.5 rounded border-slate-600 bg-slate-900 text-brand-red focus:ring-brand-red/20" />
              <span className="text-[10px] font-bold text-slate-400 group-hover:text-slate-300 transition-colors">Solo con existencia</span>
            </label>
            <button className="text-[10px] font-black text-brand-red uppercase tracking-tighter hover:text-red-400 transition-colors">Limpiar</button>
          </div>
        </div>
                  ...
                  {cat.items.map((item, idx) => (
                    <button
                      ...
                      className={`w-full text-left pl-6 py-2 text-xs transition-colors ${
                        activeItem === item
                          ? 'text-brand-lightblue font-medium bg-brand-blue/20 border-l-2 border-brand-lightblue'
